...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(texts[0], 100, middle + index[0], paint2);
        canvas.drawText(texts[1], 200, middle + index[1], paint2);
        canvas.drawText(texts[2], 300, middle + index[2], paint2);
        canvas.drawText(texts[3], 400, middle + index[3], paint2);
        canvas.drawText(texts[4], 500, middle + index[4], paint2);
        canvas.drawText(texts[5], 600, middle + index[5], paint2);
    }
}